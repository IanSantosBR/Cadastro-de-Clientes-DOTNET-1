...
namespace Cadastro_de_Clientes {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ClientesRow AddClientesRow(string Nome, string Cpf, string Endereco, string Telefone) {
...
namespace Cadastro_de_Clientes.DatabaseDataSetTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Clientes] ([Nome], [Cpf], [Endereco], [Telefone]) VALUES (@Nom" +
                "e, @Cpf, @Endereco, @Telefone);\r\nSELECT ClienteId, Nome, Cpf, Endereco, Telefone" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Clientes] SET [Nome] = @Nome, [Cpf] = @Cpf, [Endereco] = @Endereco," +
                " [Telefone] = @Telefone WHERE (([ClienteId] = @Original_ClienteId));\r\nSELECT Cli" +
                "enteId, Nome, Cpf, Endereco, Telefone FROM Clientes WHERE (ClienteId = @ClienteI" +
                "d)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Cadastro_de_Clientes.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ClienteId, Nome, Cpf, Endereco, Telefone FROM dbo.Clientes";
        ...
        public virtual int Insert(string Nome, string Cpf, string Endereco, string Telefone) {
            if ((Nome == null)) {
        ...
        public virtual int Update(string Nome, string Cpf, string Endereco, string Telefone, int Original_ClienteId, int ClienteId) {
            if ((Nome == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nome, string Cpf, string Endereco, string Telefone, int Original_ClienteId) {
            return this.Update(Nome, Cpf, Endereco, Telefone, Original_ClienteId, Original_ClienteId);
        }
    }
